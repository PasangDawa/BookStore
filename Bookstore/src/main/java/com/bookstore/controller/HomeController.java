...
public class HomeController {
	...
	public String forgotPassword(HttpServletRequest request, @ModelAttribute("email") String email, Model model) {
		...
		SimpleMailMessage jEmail = mailConstructor.constructResetTokenEmail(appUrl, request.getLocale(), token, user,
				password);

		mailSender.send(jEmail);
	...
	public String myProfile(Model model, Principal principal) {
		...
		List<String> stateList = AUConstants.listOfAUStatesCode;
	...
	public String setDefaultShippingAddresss(@ModelAttribute("defaultShippingId") Long defaultShippingId,
